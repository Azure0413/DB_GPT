    ...
    <div className="d-flex">
      ...
      <div className="flex-grow-1 d-flex flex-column">
        ...
        <div className="d-flex flex-column justify-content-center" style={{ position: "fixed", left: "450px", top: "50px", width: '100%' }}>
          ...
          <div className="chat-window" style={{ width: "60%", height: "400px", overflowY: "auto", position: "absolute", left: "-30px", top: "70px", padding: "10px", border: "none", marginBottom: "20px" }}>
